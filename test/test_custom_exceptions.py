...
class TestCustomExceptions:
    ...
    @pytest.mark.parametrize("exception_name, exception_args", [
        ...
        (ce.PkgVersionWithCommitRef, ("dummy_commit_ref", "dummy_pkg_version"))

    ])
    def test_exception_init_and_print(self, exception_name, exception_args,
                                      capsys):
