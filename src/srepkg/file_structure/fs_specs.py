...
repackaging_components = [
    ...
    SCD(
        ...
        contents=[
            SCD(
                pname="srepkg_control_components",
                sc="srepkg_control_components",
                contents=[
                    SCF(
                        pname="__init__.py", sc="srepkg_control_components_init"
                    ),
                    SCF(pname="entry_point_runner.py", sc="entry_module"),
                    SCF(
                        pname="srepkg_control_paths.py",
    ...
    SCD(
        pname="multiple_layers",
        sc="template_files",
        contents=[SCF(pname="pkg_names.py.template", sc="pkg_names_template")],
    ),
]
