...
class WheelEntryPointsRenamer:
    def __init__(self, wheel_dist_info: WheelDistInfo):
        self.wheel_dist_info = wheel_dist_info
...
if __name__ == "__main__":
    ...
    wheel_modifier = WheelEntryPointsRenamer(my_wheel_dist_info)
