...
class TestPathCalc(unittest.TestCase):
    ...
    def test_builder_dest_paths(self):
        ...
        srepkg_inner = srepkg_root / calc_paths.locals["final_srepkg_name"]
        srepkg_entry_points = srepkg_inner / "srepkg_entry_points"
        ...
        srepkg_init = srepkg_inner / "__init__.py"

        assert builder_dest_paths.srepkg == srepkg_inner
