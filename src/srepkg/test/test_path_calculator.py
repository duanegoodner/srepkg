...
def calc_test_paths(pkg_root: Path = t_data.package_test_cases.t_proj_info.
                    pkg_root):
    ...
    builder_paths_calculator.srepkg_pkgs_dir = \
        t_data.package_test_cases.t_proj_srepkg_info.test_srepkg_pkgs_dir
...
class TestPathCalculator(unittest.TestCase):
    ...
    def setUpClass(cls) -> None:
        if t_data.package_test_cases.t_proj_srepkg_info.srepkg_root.exists():
    ...
    def test_builder_dest_paths(self):
        ...
        srepkg_path = t_data.package_test_cases.t_proj_srepkg_info.\
            srepkg_root / \
            ('t_proj' + 'srepkg')
        ...
        srepkg_setup_cfg = t_data.package_test_cases.t_proj_srepkg_info.\
            srepkg_root / 'setup.cfg'
        srepkg_setup_py = t_data.package_test_cases.t_proj_srepkg_info.\
        ...
        assert builder_dest_paths.root == t_data.package_test_cases.\
